...
public class Placar {
     ...
     * Após a chamada, aquela posição torna-se ocupada e não pode ser usada uma
     * segunda vez.
     *
     ...
     * a um valor de um dado. Supões-se que cada dado pode ter valor entre 1 e
     * 6.
     * @throws IllegalArgumentException - Se a posição estiver ocupada ou se for
     * passado um valor de posição inválido, essa exceção é lançada. Não é feita
     * nenhuma verificação quanto ao tamanho do array nem quanto ao seu
     * conteúdo.
     */
    ...
    /**
     * Computa a soma dos valores obtidos, considerando apenas as posições que
     * já estão ocupadas.
     *
    ...
    /**
     * A representação na forma de string, mostra o placar completo, indicando
     * quais são as posições livres (com seus respectivos números) e o valor
     * obtido nas posições já ocupadas. Por exemplo: <br>
     * <pre>
     * (1)    |   (7)    |   (4)
     * --------------------------
     * (2)    |   20     |   (5)
